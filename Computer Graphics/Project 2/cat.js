...
var lightAmbient = vec4(0.3, 0.4, 0.5, 1.0);
var lightDiffuse = vec4(0.4, 1.0, 0.0, 1.0);
var lightSpecular = vec4(0.7, 0.9, 1.0, 1.0);

var materialAmbient = vec4(0.8, 0.8, 0.8, 1.0);
var materialDiffuse = vec4(0.8, 0.7, 0.8, 1.0);
var materialSpecular = vec4(0.9, 0.8, 1.0, 1.0);
...
// Tüm değerlerimiz 0-1 arasında olduğu için 0.5 ile çarmamıza gerek yok lab videosunda olduğu gibi.
var textureCoords = [
	// Texture coordinates
	0.2290, 0.9000,
	0.2083, 0.8942,
...
window.onload = function init() {
	...
	gl.bufferData(gl.ARRAY_BUFFER, flatten(meshNormals), gl.STATIC_DRAW);
